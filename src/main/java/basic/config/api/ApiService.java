...
public class ApiService {
	...
	public ArrayList<TourSpotDTO> getIndexTour() {
		...
		sb.append("&pageNo=" + randModule.getRndInt(0, 12));	// 페이지 랜덤 선택
